...
metadata:
  ...
  role: mixin
  abstract: false
  inherited-by: "plan-goal-breakdown-codebase-memory, plan-goal-breakdown-agility-codebase-memory"
---
...
`inherits: ... codebase-memory` (currently `plan-goal-breakdown-codebase-memory` and
`plan-goal-breakdown-agility-codebase-memory`). Inheritors rely on the tool names, workflows, and
